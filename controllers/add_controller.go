...
//+kubebuilder:rbac:groups=basic.calc.k8s,resources=adds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=basic.calc.k8s,resources=adds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=basic.calc.k8s,resources=adds/finalizers,verbs=update
